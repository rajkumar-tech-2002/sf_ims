...
const CustomerReportPrint = ({ data }) => {
    return (
            ...
            <table className="w-full border-collapse border border-black">
                <thead>
                    <tr className="bg-white">
                        ...
                        <th className="border border-black p-1 text-[10px] text-rose-900 font-bold uppercase text-center w-16">ID</th>
                        <th className="border border-black p-1 text-[10px] text-rose-900 font-bold uppercase text-left w-48">NAME</th>
                        <th className="border border-black p-1 text-[10px] text-rose-900 font-bold uppercase text-left w-64">ADDRESS</th>
                        <th className="border border-black p-1 text-[10px] text-rose-900 font-bold uppercase text-left w-32">CONTACT</th>
                        <th className="border border-black p-1 text-[10px] text-rose-900 font-bold uppercase text-center w-32">MOBILE</th>
                    </tr>
                </thead>
                <tbody>
                    {data.map((row, index) => (
                        <tr key={index} className="border-b border-black">
                            ...
                            <td className="border border-black p-1 text-[10px] text-center">{row.customer_id}</td>
                            <td className="border border-black p-1 text-[10px] uppercase font-medium">{row.customer_name}</td>
                            <td className="border border-black p-1 text-[10px] uppercase">{row.customer_address || '---'}</td>
                            <td className="border border-black p-1 text-[10px] uppercase">{row.customer_contact || '---'}</td>
                            <td className="border border-black p-1 text-[10px] text-center tracking-wider">{row.customer_mobile}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
